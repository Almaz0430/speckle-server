...
const ru: Translations = {
  ...
  projects: {
    ...
    filters: {
      projectsToMove: 'Проекты для перемещения'
    },
    deleteDialog: {
    ...
    card: {
      readyToMove: 'Готов к перемещению',
      updated: 'Обновлён',
      ownerCanMove: 'Как владелец проекта вы можете переместить его в рабочее пространство',
    ...
    moveToWorkspace: {
      ...
      bannerTitleProjects: 'Переместите ваши проекты в рабочее пространство',
      description: 'Личные проекты постепенно выводятся из использования. Переместите ваши проекты в рабочее пространство, чтобы создавать новые проекты и модели, приглашать участников и просматривать комментарии и версии старше 7 дней. К 1 января 2026 года все проекты, которые не были перемещены в рабочее пространство, будут удалены.',
      onlyOwnerTooltip: 'Только владелец проекта может переместить его в рабочее пространство',
      moveProject: 'Переместить проект',
      moveProjects: 'Переместить проекты'
    },
    addDialog: {
      workspaceSubheading: 'Новые проекты можно создавать только в рамках рабочего пространства.',
